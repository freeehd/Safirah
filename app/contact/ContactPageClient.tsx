 ...
 * Client component wrapper for SEO server component
 */
          ...
          <aside className="space-y-6">
            <Card>
              <div className="flex items-center gap-4">
                <img src="/assets/1.webp" alt="Hirah Safi - Faith-aligned life coach Toronto" className="h-16 w-16 rounded-2xl object-cover" />
                <div>
