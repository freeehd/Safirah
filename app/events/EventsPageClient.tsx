  ...
  const featured = [
    {
      title: "Bloom &",
      highlight: "Belong",
      subtitle: "Flower Circle • Rescheduling",
      ...
      dateDay: "Rescheduling",
      dateMon: "New Dates TBA",
      timeStart: "Afternoon",
      timeEnd: "Toronto",
      locName: "George Brown College",
      locCity: "Toronto Downtown",
      venue: "In-Person Circle",
      investment: "$25",
      discountBadge: "Waitlist Open",
      btnText: "Join Waitlist →",
      link: "/events/bloom-and-belong#waitlist",
      btn2Text: "Explore Event",
      link2: "/events/bloom-and-belong#what-it-is",
      image: "/assets/hirah-1.jpeg",
      badge: "Postponed · Waitlist Open",
      theme: {
